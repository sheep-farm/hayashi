...
O dataset \texttt{beauty} do Wooldridge é usado nos casos de validação
\texttt{ologit\_beauty} e \texttt{oprobit\_beauty} em \texttt{validation/cases/},
e o dataset \texttt{AER::TravelMode} é usado no caso \texttt{mlogit\_mode}. Os
casos estimam modelos de logit ordenado, probit ordenado e logit multinomial
no \hayashi{} e comparam os coeficientes com implementações de referência em R
e Python. Execute \lstinline{hay validate} para ver o estado atual.
