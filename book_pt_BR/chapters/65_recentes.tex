...
`lpdid` (DiD por Projeções Locais) e `eventstudy` estimam efeitos de
tratamento em desenhos com adoção escalonada. `eventstudy` constrói
...
diferenças. `synthdid` estima pesos de unidade e tempo a partir dos
