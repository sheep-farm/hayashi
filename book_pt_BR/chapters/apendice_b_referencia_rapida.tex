...
Espectral         & \texttt{spectral(df, x="v1,v2", k=3)} \\
...
\textbf{Modelo} & \textbf{Sintaxe} \\
\midrule
SAR espacial         & \texttt{spatial\_sar(y \textasciitilde{} x1 + x2, df, w=W)} \\
SEM espacial         & \texttt{spatial\_sem(y \textasciitilde{} x1 + x2, df, w=W)} \\
Durbin espacial      & \texttt{spatial\_durbin(y \textasciitilde{} x1 + x2, df, w=W)} \\
SAR em painel        & \texttt{spatial\_panel\_sar(y \textasciitilde{} x, df, w=W, id="e")} \\
SEM em painel        & \texttt{spatial\_panel\_sem(y \textasciitilde{} x, df, w=W, id="e")} \\
Durbin error em painel & \texttt{spatial\_durbin\_error(y \textasciitilde{} x, df, w=W, id="e")} \\
\bottomrule
\end{tabular}
\end{center}
