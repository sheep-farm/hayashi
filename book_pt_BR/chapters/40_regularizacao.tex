...
O dataset de preços de imóveis \texttt{hprice1} do Wooldridge é usado nos casos
de validação \texttt{ridge\_hprice1}, \texttt{elasticnet\_hprice1} e
\texttt{lasso\_hprice1} em \texttt{validation/cases/}. Os casos estimam
regressões Ridge, Elastic Net e LASSO no \hayashi{} e comparam os coeficientes
com implementações de referência em R e Python. Execute \lstinline{hay validate}
