...
generate df u  = rnormal()                    // ruído de atribuição
...
════════════════════════════════════════════════════════════════════════
 Outcome: y   Tratamento: d
 k=1 match   Caliper: nenhum   Bootstrap SE: 200 reps
 N tratados: 503   N controles: 497   N tratados matchados: 497
────────────────────────────────────────────────────────────────────────
 ATT = 2.2168   SE = 0.0643   z = 34.483   P>|z| = 0.0000  ***
 IC 95%: [2.0908, 2.3428]
────────────────────────────────────────────────────────────────────────
 Balanço  x1:  μ_Trat=0.542  μ_Ctrl(raw)=0.461  μ_Ctrl(mtch)=0.461
                SMD_ant=0.291   SMD_dep=0.291
 (!) SMD > 0.10 após matching — covariável mal balanceada
════════════════════════════════════════════════════════════════════════
\end{lstlisting}

Sem caliper, o matching aceita pares distantes em $\hat{p}$. O balanceamento
não melhora (SMD = 0.291 antes e depois) e a estimativa permanece viesada
($\hat\tau = 2{,}22$).
...
════════════════════════════════════════════════════════════════════════
 ...
 N tratados: 503   N controles: 497   N tratados matchados: 449
────────────────────────────────────────────────────────────────────────
 ATT = 2.0323   SE = 0.0233   z = 87.157   P>|z| = 0.0000  ***
 IC 95%: [1.9866, 2.0780]
────────────────────────────────────────────────────────────────────────
 Balanço  x1:  μ_Trat=0.542  μ_Ctrl(raw)=0.461  μ_Ctrl(mtch)=0.485
                SMD_ant=0.291   SMD_dep=0.204
════════════════════════════════════════════════════════════════════════
\end{lstlisting}

Com caliper $= 0{,}05$, o ATT estimado é $2{,}03$ — praticamente sobre o
valor verdadeiro. O preço é a perda de 54 tratados sem par aceitável
(503 → 449). O caliper reduz o SMD de 0.29 para 0.20, evidenciando melhor
balanceamento.\footnote{%
