...
O DGP deste capítulo com variável de corrida uniforme e limiar em 0 é usado
no caso de validação \texttt{rdd\_book} em \texttt{validation/cases/}. O
caso estima o efeito de tratamento por RDD em \hayashi{} e o compara com
implementações de referência em R e Python. Execute \lstinline{hay validate}
