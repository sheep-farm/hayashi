...
\texttt{arima\_book} em \texttt{validation/cases/}. O caso estima um
ARIMA(1,1,0) em \hayashi{} e o compara com as implementações de referência em
R e Python. Execute \lstinline{hay validate} para ver o estado atual.
