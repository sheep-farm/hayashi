...
Os DGPs deste capítulo são usados como casos de validação automática em
\texttt{validation/cases/}: \texttt{ar\_book}, \texttt{ma\_book} e
\texttt{arma\_book}. Cada caso executa o script \hayashi{} e o compara com
implementações de referência em R e Python que replicam o estimador
Hannan-Rissanen padrão do \hayashi{}. Execute \lstinline{hay validate} para
ver o estado atual.
