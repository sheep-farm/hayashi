...
O dataset \texttt{mroz} é usado no caso de validação
\texttt{heckman\_mroz} em \texttt{validation/cases/}. O caso estima o modelo
Heckman de dois passos em \hayashi{} e o compara com uma implementação de
Heckit em R e Python. Execute \lstinline{hay validate} para ver o estado
atual.
