...
Use \texttt{m\_km.labels} para ler o cluster atribuído e \texttt{m\_km.centroids} para
...
\texttt{hclust} pode ser cortado em qualquer número de grupos.
...
K-Means falha. O \texttt{spectral} é experimental e exige
...
PCA e análise fatorial reduzem a dimensionalidade linearmente. \texttt{biplot}
...
\texttt{kde} estima a densidade de uma única variável com um kernel escolhido.
