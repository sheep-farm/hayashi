...
O dataset \texttt{fertil2} do Wooldridge é usado nos casos de validação
\texttt{poisson\_fertil2} e \texttt{nbreg\_fertil2} em \texttt{validation/cases/}.
Os casos estimam modelos de Poisson e Binomial Negativa para o número de filhos
no \hayashi{} e comparam coeficientes e erros-padrão com implementações de
referência em R e Python. Execute \lstinline{hay validate} para ver o estado atual.
