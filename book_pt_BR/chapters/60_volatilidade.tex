...
`sv` reporta $\mu$, $\phi$ (persistência), $\sigma_\eta$
...
`copula` estima um modelo bivariado de dependência via Teorema de
...
`tv_copula` estende isso com dependência variante no tempo impulsionada
