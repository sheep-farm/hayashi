...
\subsection{Hausman robusto}

O teste de Hausman clássico requer que o estimador RE seja eficiente sob
$H_0$. Sob heterocedasticidade ou clustering, isso falha e a estatística
pode ser negativa ou enganosa. A versão robusta
(Cameron \& Trivedi 2005; Wooldridge 2010) usa a covariância robusta das
diferenças dos coeficientes:
...
\begin{lstlisting}[caption={Teste de Hausman robusto}]
