...
- [Instrumental Variables](./estimation/iv.md)
- [Panel Data](./estimation/panel.md)
...
- [Diagnostics](./post/diagnostics.md)
- [Bootstrap](./post/bootstrap.md)

# Language

- [Variables & Types](./language/types.md)
- [Control Flow](./language/control.md)
...
- [Comparison with Stata](./reference/stata.md)
