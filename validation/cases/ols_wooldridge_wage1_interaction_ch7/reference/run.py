# Reference implementation in Python/statsmodels for Wooldridge wage1,
...
# Create combined dummy categories from female and married.
...
model = smf.ols("lwage ~ 1 + marrmale + marrfem + singfem + educ + exper + expersq + tenure + tenursq", data=df).fit()
