# Reference implementation in Python/statsmodels for Wooldridge prminwge,
...
CSV_PATH = DATA_DIR / "prminwge.csv"
...
if not CSV_PATH.exists():
    try:
        ...
        url = "https://raw.githubusercontent.com/vincentarelbundock/Rdatasets/master/csv/wooldridge/prminwge.csv"
        df = pd.read_csv(url)
...
model = smf.ols("lprepop ~ 1 + lmincov + lusgnp", data=df).fit()
