...
johansen_vecm <- function(data, lags, rank) {
  ...
  list(alpha = alpha_est, beta = beta_est)
}
...
json_str <- paste0(
  ...
  '},"standard_errors":{',
  '"beta_1_y1":', format(result$standard_errors$beta_1_y1, digits = 1),
  ',"beta_1_y2":', format(result$standard_errors$beta_1_y2, digits = 1),
  ',"alpha_1_y1":', format(result$standard_errors$alpha_1_y1, digits = 1),
  ',"alpha_1_y2":', format(result$standard_errors$alpha_1_y2, digits = 1),
  '}}'
)
