# Reference implementation in Python/statsmodels for Wooldridge campus,
...
if not CSV_PATH.exists():
    try:
        ...
        url = "https://raw.githubusercontent.com/vincentarelbundock/Rdatasets/master/csv/wooldridge/campus.csv"
        df = pd.read_csv(url)
...
model = smf.ols("lcrime ~ 1 + lenroll", data=df).fit()
