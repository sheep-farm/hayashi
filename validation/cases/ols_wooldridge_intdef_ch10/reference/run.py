# Reference implementation in Python/statsmodels for Wooldridge intdef,
...
if not CSV_PATH.exists():
    try:
        ...
        url = "https://raw.githubusercontent.com/vincentarelbundock/Rdatasets/master/csv/wooldridge/intdef.csv"
        df = pd.read_csv(url)
...
df = df.rename(columns={"inf": "inflation", "def": "deficit"})

# Estimate the model from Chapter 10, Example 10.2.
model = smf.ols("i3 ~ 1 + inflation + deficit", data=df).fit()
