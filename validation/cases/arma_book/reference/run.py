# Reference implementation in Python for the book ARMA(1,1) case.
...
z = pd.read_csv(DATA_DIR / "arma.csv")["y"].to_numpy()
t = len(z)
p = 1
q = 1
...
x_final = np.zeros((n_final, 1 + p + q))
