# Reference implementation in Python/statsmodels for Wooldridge consump,
...
if not CSV_PATH.exists():
    try:
        ...
        url = "https://raw.githubusercontent.com/vincentarelbundock/Rdatasets/master/csv/wooldridge/consump.csv"
        df = pd.read_csv(url)
...
df = df.dropna(subset=["gc", "gy"])

# Estimate the model from Chapter 10, Example 10.4.
model = smf.ols("gc ~ 1 + gy", data=df).fit()
