...
data_dir <- "validation/cases/ols_wooldridge_crime1_ch3/data"
...
model <- lm(narr86 ~ pcnv + ptime86 + qemp86, data = crime1)
...
out_dir <- "validation/cases/ols_wooldridge_crime1_ch3/reference"
