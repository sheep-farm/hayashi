# Reference implementation in Python for the probit labour-force participation case.
...
model = smf.probit("inlf ~ nwifeinc + educ + exper + age + kidslt6 + kidsge6", data=df).fit(disp=0)
