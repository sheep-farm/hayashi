# Reference implementation in Python/statsmodels for Wooldridge gpa1,
...
if not CSV_PATH.exists():
    try:
        ...
        url = "https://raw.githubusercontent.com/vincentarelbundock/Rdatasets/master/csv/wooldridge/gpa1.csv"
        df = pd.read_csv(url)
...
model = smf.ols("colGPA ~ 1 + hsGPA + ACT", data=df).fit()
