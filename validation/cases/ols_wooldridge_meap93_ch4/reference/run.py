# Reference implementation in Python/statsmodels for Wooldridge meap93,
# Chapter 4, Examples 4.2 and 4.10.
...
if not CSV_PATH.exists():
    try:
        ...
        url = "https://raw.githubusercontent.com/vincentarelbundock/Rdatasets/master/csv/wooldridge/meap93.csv"
        df = pd.read_csv(url)
...
model = smf.ols("math10 ~ 1 + ltotcomp + lstaff + lenroll", data=df).fit()
