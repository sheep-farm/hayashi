# Reference implementation in Python/statsmodels for Wooldridge jtrain,
...
if not CSV_PATH.exists():
    try:
        ...
        url = "https://raw.githubusercontent.com/vincentarelbundock/Rdatasets/master/csv/wooldridge/jtrain.csv"
        df = pd.read_csv(url)
...
df = df.dropna(subset=["lscrap", "d88", "d89", "grant", "grant_1", "lsales", "lemploy"])

# Estimate the model from Chapter 14, Example 14.3.
model = smf.ols("lscrap ~ 1 + d88 + d89 + grant + grant_1 + lsales + lemploy", data=df).fit()
