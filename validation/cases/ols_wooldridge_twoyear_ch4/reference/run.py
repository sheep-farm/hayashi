# Reference implementation in Python/statsmodels for Wooldridge twoyear,
...
if not CSV_PATH.exists():
    try:
        ...
        url = "https://raw.githubusercontent.com/vincentarelbundock/Rdatasets/master/csv/wooldridge/twoyear.csv"
        df = pd.read_csv(url)
...
model = smf.ols("lwage ~ 1 + jc + univ + exper", data=df).fit()
