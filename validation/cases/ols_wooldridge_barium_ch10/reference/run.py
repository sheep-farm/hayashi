# Reference implementation in Python/statsmodels for Wooldridge barium,
...
if not CSV_PATH.exists():
    try:
        ...
        url = "https://raw.githubusercontent.com/vincentarelbundock/Rdatasets/master/csv/wooldridge/barium.csv"
        df = pd.read_csv(url)
...
model = smf.ols("lchnimp ~ 1 + lchempi + lgas + lrtwex + befile6 + affile6 + afdec6", data=df).fit()
