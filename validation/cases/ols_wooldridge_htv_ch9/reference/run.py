# Reference implementation in Python/statsmodels for Wooldridge htv,
...
if not CSV_PATH.exists():
    try:
        ...
        url = "https://raw.githubusercontent.com/vincentarelbundock/Rdatasets/master/csv/wooldridge/htv.csv"
        df = pd.read_csv(url)
...
# Estimate the model from Chapter 9, Example 9.3.
model = smf.ols("educ ~ 1 + motheduc + fatheduc + abil", data=df).fit()
