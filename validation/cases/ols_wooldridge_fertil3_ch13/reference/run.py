# Reference implementation in Python/statsmodels for Wooldridge fertil3,
...
if not CSV_PATH.exists():
    try:
        ...
        url = "https://raw.githubusercontent.com/vincentarelbundock/Rdatasets/master/csv/wooldridge/fertil3.csv"
        df = pd.read_csv(url)
...
df = df.dropna(subset=["gfr", "pe", "pe_1", "pe_2", "ww2", "pill"])

# Estimate the model from Chapter 13, Example 13.3.
model = smf.ols("gfr ~ 1 + pe + pe_1 + pe_2 + ww2 + pill", data=df).fit()
