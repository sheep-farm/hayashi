# Reference implementation in R for ZIP on Wooldridge affairs.
...
case_dir <- "validation/cases/zip_affairs"
...
model <- zeroinfl(formula_count, data = affairs, dist = "poisson", link = "logit")
sm <- summary(model)
