# Reference implementation in Python/statsmodels for Wooldridge sleep75,
# Chapter 5, Problem 3.3.
...
if not CSV_PATH.exists():
    try:
        ...
        url = "https://raw.githubusercontent.com/vincentarelbundock/Rdatasets/master/csv/wooldridge/sleep75.csv"
        df = pd.read_csv(url)
...
model = smf.ols("sleep ~ 1 + totwrk + educ + age", data=df).fit()
