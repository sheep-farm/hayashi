# Reference implementation in Python/statsmodels for Wooldridge vote1,
# Chapter 2, Examples 2.5 and 2.9.
...
if not CSV_PATH.exists():
    try:
        ...
        url = "https://raw.githubusercontent.com/vincentarelbundock/Rdatasets/master/csv/wooldridge/vote1.csv"
        df = pd.read_csv(url)
...
model = smf.ols("voteA ~ 1 + shareA", data=df).fit()
