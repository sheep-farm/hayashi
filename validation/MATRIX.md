...
| mlp | simulated | R, Python | pass | — | Simulated linear-ish y from x1 and x2 with small noise. Compare R-squared against scikit-learn MLPRegressor (logistic activation, adam solver). Only Python reference because R lacks an equivalent stable MLP package for this use. |
