...
| ridge | wooldridge::hprice1 | R:passed, Python:passed * | pass | — | Ridge regression of log house price on log lot size, log square footage, bedrooms and colonial dummy. |
