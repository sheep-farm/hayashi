...
\begin{lstlisting}
let slim = select(df, ano, uf, renda)    // mantém só essas colunas
...
rename df renda_familiar renda    // renomeia renda_familiar para renda
\end{lstlisting}
...
dropna df renda gini      // remove linhas com NaN em renda ou gini
\end{lstlisting}
...
\begin{lstlisting}
replace df renda = 0 if renda < 0       // zera valores negativos
