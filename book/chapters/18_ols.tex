...
// mesma semente e mesmo DGP do bloco anterior
let m1 = ols(y ~ x1 + x2, df)   // especificação correta
let m2 = ols(y ~ x1, df)         // x2 omitido
esttab(m1, m2)
\end{lstlisting}
...
\noindent O coeficiente de $x_1$ mal se altera (1.8000 $\to$ 1.7745) porque
$x_1$ e $x_2$ são gerados independentemente — a correlação amostral é
próxima de zero. Já a constante distorce de 2.5000 para 2.1515 porque
