...
Esta combinação — ranges como listas de primeira classe, \lstinline{chain} variádico
e closure leve — não existe com esta sintaxe em nenhuma outra linguagem. Rust exige
encadeamento de métodos; Haskell separa \texttt{map} e concatenação; Julia e Python
chegam perto, mas com mais ruído sintático.
