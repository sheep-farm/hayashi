/* @ts-self-types="./hayashi_lang.d.ts" */

/**
 * @param {string} source
 * @returns {string}
 */
export function run_hayashi(source) {
    let deferred2_0;
    let deferred2_1;
    try {
        ...
        wasm.run_hayashi(retptr, ptr0, len0);
...
export function set_print_callback(cb) {
    wasm.set_print_callback(addHeapObject(cb));
}
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_append_52800d6b56f733ed: function() { return handleError(function (arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('hayashi_lang_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
