...
Some later chapters and the quick-reference appendix describe
commands that are still gated by the \texttt{experimental} Cargo feature.
To use them, build or install Hayashi with \texttt{--features experimental}.
