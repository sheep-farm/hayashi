...
`lpdid` (Local Projections DiD) and `eventstudy` estimate treatment
effects in designs with staggered adoption. `eventstudy` constructs
...
differences. `synthdid` estimates unit and time weights from the pre-
