...
The DGPs in this chapter are used as automated validation cases in
\texttt{validation/cases/}: \texttt{ar\_book}, \texttt{ma\_book}, and
\texttt{arma\_book}. Each case runs the \hayashi{} script and compares it with
R and Python reference implementations that replicate \hayashi{}'s default
Hannan-Rissanen estimator. Run \lstinline{hay validate} to see the current
status.
