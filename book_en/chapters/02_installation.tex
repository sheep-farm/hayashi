...
\hayashi{} also provides a Jupyter kernel. To build and install it from source:
...
Then start JupyterLab or Jupyter Notebook and select the \textbf{Hayashi}
kernel. See the corresponding chapter for details.
