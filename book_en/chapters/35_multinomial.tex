...
The Wooldridge \texttt{beauty} dataset is used in the \texttt{ologit_beauty}
validation case in \texttt{validation/cases/}. The case estimates an ordered
logit in \hayashi{} and compares it with \texttt{MASS::polr} in R and with
\texttt{statsmodels.miscmodels.ordinal_model} in Python. Run
