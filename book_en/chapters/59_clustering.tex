...
Use \texttt{m\_km.labels} to read the assigned cluster and \texttt{m\_km.centroids} to
inspect the cluster means.

\section{Hierarchical clustering and DBSCAN}

Hierarchical clustering builds a tree of nested clusters. \texttt{hclust}
...
\texttt{spectral} is experimental and requires \texttt{--features experimental}.
...
PCA and factor analysis reduce dimensionality linearly. \texttt{biplot}
...
\texttt{kde} estimates the density of a single variable with a chosen kernel.
