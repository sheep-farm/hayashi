...
The Wooldridge \texttt{hprice1} house-price dataset is used in the
validation cases \texttt{ridge\_hprice1}, \texttt{elasticnet\_hprice1} and
\texttt{lasso\_hprice1} in \texttt{validation/cases/}. The cases estimate Ridge,
Elastic Net and LASSO regressions in \hayashi{} and compare the coefficients
