...
The cointegrated DGP in this chapter is used in the \texttt{coint\_book}
validation case in \texttt{validation/cases/}. The case estimates a rank-1
VECM in \hayashi{} and compares it with reference implementations in R and
