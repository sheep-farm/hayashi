...
They all require a treatment indicator `d` and a set of covariates `x`.
...
`bsc` implements a Bayesian version of the synthetic-control estimator.
...
`dml_crossfit` estimates the ATE in a partially linear model
